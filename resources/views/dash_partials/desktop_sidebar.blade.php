    ...
    <div class="text-gray-500 dark:text-gray-400">
        ...
        <li class="relative px-6 py-3">
            ...
            <ul
                ...
                class="hidden p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
                aria-label="submenu"
                id="accordion"
            >
                <li
