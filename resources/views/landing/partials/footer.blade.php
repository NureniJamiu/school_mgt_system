<footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
    ...
    <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
        <h3 class="font-bold text-2xl mb-4">Modrasah</h3>
        <p class="text-gray-400">Dedicated to providing Arabic language education & Islamic studies for students of all ages.</p>
    ...
    <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
        <h5 class="uppercase tracking-wider font-semibold text-gray-500">Subjects</h5>
        <ul class="mt-4">
        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Islamic History</a></li>
        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Arabic Writing</a></li>
        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Quran</a></li>
        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Hadith</a></li>
        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Fiqh</a></li>
        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Taoheed</a></li>
    ...
    <div class="w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4 lg:pr-8">
        ...
        <li>
            ...
            <span class="ml-3">
                1 Kajero Adan, Off Moshalashi Bustop, Epe, Lagos, Nigeria.
            </span>
            </a>
        </li>
        <li class="mt-4">
    ...
    <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
        <h5 class="uppercase tracking-wider font-semibold text-gray-500">Our Socials</h5>
        <ul class="mt-4 flex">
        <li>
        ...
        <p class="text-sm text-gray-400 mt-12">© 2023 Modrasah. <br class="hidden lg:block">All Rights Reserved.
        </p>
    </div>
    </div>
</footer>